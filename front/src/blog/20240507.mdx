...
<comp.ui.Image src="/assets/images/blog/20240507/dog.png" alt="いつの日か撮った置物の犬" />
...
筆者が記事執筆初心者のため、[こちらの記事](https://qiita.com/mkt_hanada/items/923bbf9a9e51d6aa16b3)を参考に書いていきます。
...
<comp.ui.Image src="/assets/images/blog/20240507/yanosea-org-diagram.png" alt="yanosea.orgの構成図" />

## 🏗️ インフラ

このサイトは[Xserver VPS](https://vps.xserver.ne.jp)のLinuxマシンにデプロイされています。
昨今だと[Netlify](https://www.netlify.com)や[Vercel](https://vercel.com)にデプロイするのがパフォーマンス面やコスト面で優れていると思っています。
...
<comp.ui.Image src="/assets/images/blog/20240507/fee-vps.png" alt="VPSの料金" />

ドメイン料金 : ￥946

<comp.ui.Image src="/assets/images/blog/20240507/fee-domain.png" alt="ドメインの料金" />

SSL証明書発行料金 : ￥1,045

<comp.ui.Image src="/assets/images/blog/20240507/fee-ssl.png" alt="SSL証明書発行の料金" />
...
公開先のディレクトリに[Astro](https://astro.build)でビルドした静的サイトを配置しています。
...
フロントエンドは[Astro](https://astro.build)というWebフレームワークを使用しました。
Astroについては[こちらの記事](https://qiita.com/udayaan/items/24ecb2f5f4608fc1df4c)がとても分かりやすく簡潔に書かれていたため、この紹介のみとさせていただきます。
CSSフレームワークには[tailwindcss](https://tailwindcss.com)を使用しています。
...
バックエンドは[Golang](https://go.dev)を採用しました。 Web API フレームワークとして[Echo](https://echo.labstack.com)を採用しました。
