...
<a
  href={frontmatter.images[1].url}
  data-lightbox={frontmatter.images[1].alt}
  data-title={frontmatter.images[1].alt}
>
...
<a
  href={frontmatter.images[2].url}
  data-lightbox={frontmatter.images[2].alt}
  data-title={frontmatter.images[2].alt}
>
...
<a
  href={frontmatter.images[3].url}
  data-lightbox={frontmatter.images[3].alt}
  data-title={frontmatter.images[3].alt}
>
...
<a
  href={frontmatter.images[4].url}
  data-lightbox={frontmatter.images[4].alt}
  data-title={frontmatter.images[4].alt}
>
